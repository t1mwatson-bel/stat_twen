...
# ... дальше идёт ВЕСЬ ТВОЙ КОД (от ML-БИБЛИОТЕКА и до конца) ...
...
# =====================================================================
# ПРОВЕРКА И ПРОГНОЗ (С ДОБАВЛЕННЫМ УСЛОВИЕМ)
# =====================================================================
def check_and_predict():
    ...
    for entry in predictions:
        ...
        # ============================================================
        # 🔥 ДОБАВЛЕННОЕ УСЛОВИЕ: проверяем, есть ли прогнозируемая карта среди P1, D1, P2
        # ============================================================
        ...
        predicted_card = predicted_cards[0][0]  # первая карта из прогноза
        blocked = False
